...
if($_POST){
    ...
    if($Physics != null && $Chemistry != null && $Biology != null &&  $Mathematics != null && $Computer != null){
              ...
              <div class="col-4 offset-4 mt-3">
                    <form action="" method="post">
                        <div class="input-group mt-3">
                          ...
                          <input type="number" name="Physics" id="Physics" class="form-control" placeholder="Enter Your Physics grade">
                        </div>
                        ...
                        <div class="input-group mt-3">
                          ...
                          <input type="number" name="Chemistry" id="Chemistry" class="form-control" placeholder="Enter Your Chemistry grade">
                        </div>
                        ...
                        <div class="input-group mt-3">
                          ...
                          <input type="number" name="Biology" id="Biology" class="form-control" placeholder="Enter Your Biology grade">
                        </div>
                        ...
                        <div class="input-group mt-3">
                          ...
                          <input type="number" name="Mathematics" id="Mathematics" class="form-control" placeholder="Enter Your Mathematics grade">
                        </div>
                        ...
                        <div class="input-group mt-3">
                          ...
                          <input type="number" name="Computer" id="Computer" class="form-control" placeholder="Enter Your Computer grade">
                        </div>
