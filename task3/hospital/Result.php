...
for($i=1;$i<=5;$i++){
    ...
    if($result < 25){
     ...
     if($result <25 ){
         $Bad_Review = "<tr class='bg-danger text-center' col-span='2'><td>we will call you later on this Phone ( " . $_SESSION['phone'] . " )<td></tr>";
     }else{
        $Good_Review = "<tr class='bg-success text-center' col-span='2'><td> thanks <td></tr>";
     }
