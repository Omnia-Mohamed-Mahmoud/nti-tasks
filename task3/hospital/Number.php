...
if($_POST){
    ...
    if(empty($phone)){
        ...
        if(is_numeric($phone)){
            ...
            if(strlen($phone) != 11){
                $errors['phone-number-count'] = "<div class='alert alert-danger'> Please enter phone number contain 11 digit </div>";
            }
        }else{
        ...
        <div class="row w-100">
            <div class="col-12 d-flex flex-row justify-content-between align-items-center">
                <div class="align-self-start flex-shrink-1">
                    <img src="image/hospital.gif" alt="hospital">
                </div>
                <div class="flex-fill w-70">
                    <form action="" method="POST">
                        ...
                        if(isset($errors['phone-number-count'])){
                            echo $errors['phone-number-count'];
                        }
                        if(isset($errors['phone-number-not-int'])){
                            echo $errors['phone-number-not-int'];
                        }
                        if(isset($errors['phone-number-float'])){
                            echo $errors['phone-number-float'];
                        }
                        ?>
                        </div>
